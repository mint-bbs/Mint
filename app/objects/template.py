...
class _TemplateResponse(HTMLResponse):
    def __init__(
        ...
        content = template.render(context).encode("shift-jis")
...
class Jinja2SJISTemplates:
    """
    templates = Jinja2SJISTemplates("templates")
    ...
    def __init__(
        ...
        **env_options: typing.Any,
        ...
        assert jinja2 is not None, "jinja2 must be installed to use Jinja2SJISTemplates"
